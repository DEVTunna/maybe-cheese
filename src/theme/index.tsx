...
.swap-modal .open-currency-select-button {
  display: none;
}
...
body {
  ...
  background-image: ${({ theme }) =>
    `radial-gradient(50% 50% at 50% 50%, rgb(54 76 119 / 37%) 0%, rgb(12 18 30) 100%)`};
}
.countdownheader {
